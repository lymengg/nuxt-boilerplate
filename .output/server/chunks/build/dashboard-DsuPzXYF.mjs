...
import { _ as __nuxt_component_0$1 } from './nuxt-link-CeaKTE3h.mjs';
...
import script$1 from './index-BHZLo0Go.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const stats = ref([
      { label: "Total Expenses", value: "\u2014", icon: "\u{1F4CB}", bgClass: "bg-blue-50", iconClass: "text-blue-600" },
      ...
      { label: "Total Amount", value: "\u2014", icon: "\u{1F4B0}", bgClass: "bg-purple-50", iconClass: "text-purple-600" }
    ]);
...
//# sourceMappingURL=dashboard-DsuPzXYF.mjs.map
